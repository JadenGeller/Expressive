...
class ExpressiveTests: XCTestCase {
    ...
    func testCurriedAdd() {
        ...
        Program(declarations: [
            ...
            "global.main.Void:Void" : .Capture(.Derived(argumentName: "_", declarations: [], value:
    ...
    func testGenerator() {
        ...
        Program(declarations: [
            ...
            "global.generateFrom.Int:Void:Int" : .Capture(.Derived(argumentName: "x", declarations: [], value:
            ...
            "global.main.Void:Void" : .Capture(.Derived(argumentName: "_", declarations: ["next"], value:
                .Sequence([
    ...
    func testRecursion() {
        ...
        Program(declarations: [
            ...
            "global.factorial.Int:Int" : .Capture(.Derived(argumentName: "x", declarations: [], value: Expression.MultiArgInvoke(
    ...
    func testLoop() {
        ...
        Program(declarations: [
            ...
            "global.main.Void:Void" : .Capture(.Derived(argumentName: "_", declarations: ["x"], value:
                .Sequence([
    ...
    func testRecord() {
        ...
        Program(declarations: [
            ...
            "global.makePerson.String:Int:Person" : .Capture(.Derived(argumentName: "name", declarations: [], value:
            ...
            "Person.greet.Void:String" : .Capture(.Derived(argumentName: "self", declarations: [], value:
                .MultiArgInvoke(
            ...
            "global.main.Void:Void" : .Capture(.Derived(argumentName: "_", declarations: ["jaden"], value:
                .Sequence([
